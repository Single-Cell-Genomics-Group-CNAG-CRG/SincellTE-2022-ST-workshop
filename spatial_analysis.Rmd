...
ESR1 and ERBB2 are the two of the most common mutations in breast cancer, so one
...
# Set as 0 those cell types that contribute <1% to the spot
decon_mtrx[decon_mtrx < 0.01] <- 0
```
